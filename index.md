<section class="hero shell" aria-labelledby="home-hero-title">
  <div class="hero-copy">
    ...
    <h1 id="home-hero-title">A place to understand what is happening inside you — without being rushed or reduced to a label.</h1>
  ...
  <div class="hero-visual" aria-hidden="true">
    <span class="hero-visual-shape"></span>
    <figure class="hero-media">
      <img
        src="{{ '/assets/images/home/home-hero-winding-path-portrait.webp' | relative_url }}"
        width="1200"
        height="1500"
        alt=""
        fetchpriority="high"
...
<section class="section-panel recognition" aria-labelledby="recognition-title">
...
<section class="about-preview section-panel" aria-labelledby="about-preview-title">
...
<section class="quote-wrap" aria-label="Counselling philosophy">
...
<section class="shell cta-band" aria-labelledby="cta-title">
  <div>
    <p class="eyebrow">Next step</p>
    <h2 id="cta-title">We can begin with a simple conversation.</h2>
  </div>
  <div class="cta-copy">
    <p>Tell me a little about what has brought you here and ask what you need to know before deciding whether counselling feels right.</p>
